...
//const char* WIFI_SSID = "NETLIFE-uiogafernandezs2";
//const char* WIFI_PASS = "1704216330";

const char* WIFI_SSID = "MSI 5686";
const char* WIFI_PASS = "99Kz97$0";
...
setup()
{
  Serial.begin(115200);
  Serial.println();
  SerialBT.begin("BluetoothESP32CAM");
